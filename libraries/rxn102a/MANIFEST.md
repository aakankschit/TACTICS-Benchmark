...
Reaction id `rxn102a` in the repository-root `reactions.csv`.
...
|---|---|---|
| 0 | `reagents/rxn102a_reagent_0.smi` | 1,000 |
| 1 | `reagents/rxn102a_reagent_1.smi` | 1,000 |
...
|---|---|---|---|---|
| `scores/rxn102a.parquet` | 983,030 | 109 | 0.061 to 1.915 | maximize |
...
- 16,970 products (1.7%) are absent from the score set, having failed enumeration or conformer generation.
...
df = pl.read_parquet("libraries/rxn102a/scores/rxn102a.parquet")
