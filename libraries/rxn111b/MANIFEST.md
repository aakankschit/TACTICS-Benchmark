...
Reaction id `rxn111b` in the repository-root `reactions.csv`.

```
[#6;c,$(C(=O)O),$(C#N):3]-,:[#6;A;D2:2]=[#6;A;D1:1].[#6;$([#6]=[#6]),$(c:c):4][#35;A;D1]>>[#6:4]\[#6:1]=[#6:2]\[#6:3]
```
...
|---|---|---|
| 0 | `reagents/rxn111b_reagent_0.smi` | 1,000 |
| 1 | `reagents/rxn111b_reagent_1.smi` | 1,000 |
...
|---|---|---|---|---|
| `scores/rxn111b.parquet` | 988,027 | 109 | 0.071 to 1.628 | maximize |
...
- 11,973 products (1.2%) are absent from the score set, having failed enumeration or conformer generation.
...
df = pl.read_parquet("libraries/rxn111b/scores/rxn111b.parquet")
